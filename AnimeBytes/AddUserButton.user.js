...
var stnode = document.evaluate("//img[@title='Strikethrough']", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
...
if(stnode) {
	...
	stnode.parentNode.insertBefore(userimg, stnode.nextSibling);
	stnode.insertAdjacentHTML('afterend', '\n');
